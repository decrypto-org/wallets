...
The protocol it utilizes is as follows. First, the wallet connects to 10 servers chosen from a hardcoded list in the software. One of them is selected as primary at random. The servers speak a protocol specified by Electrum and originally proposed in~\cite{stratum} and not the full node protocol.
