...
SPV      &UTXO&Transparent&$\Theta(n+y(1+\lg(\alpha))$&$\Theta(n+y(1+\lg(\alpha))$&$\Theta(m)$&\full&\half&\full&\full&     \\
Electrum &UTXO&Transparent&$\Theta(n+y(1+\lg(\alpha))$&$\Theta(n+y(1+\lg(\alpha))$&$\Theta(1)$&     &     &\full&     &     \\
...
Light&Both&Transparent&$\Theta(polylog(n) + y(1+\lg(\alpha)))$&$\Theta(polylog(n) + y(1+\lg(\alpha)))$&$\Theta(1)$&\full&     &\full&\full&\full\\
Light&UTXO&Privacy&$\Theta(polylog(n) + y(1+\lg(\alpha)))$&$\Theta(polylog(n) + y(1+\lg(\alpha)))$&$\Theta(m)$&\full&     &\full&\full&     \\
\hline
\end{tabular}
\end{table*}
