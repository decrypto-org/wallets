...
\rot{Uncensorability}
\\ \hline
\emph{Proposal}&Model&Transparency&\multicolumn{3}{c|}{\emph{Performance $\Theta(\cdot)$}}&\multicolumn{5}{c}{\emph{Security}} \\
\hline
