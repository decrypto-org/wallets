\begin{algorithm}[H]
    \caption{\label{alg.neutrino} The Neutrino client syncing protocol for a blockchain rooted in \Gen, with access to a fixed set of servers $\mathcal{S}$ and a public key $pk$ for which all transactions must be obtained.}
    \begin{algorithmic}[1]
