...
\section{Transparent UTXO Wallets}

A transaction description specifies the desired outputs of a transaction and a fee. In the simplest case of sending some some funds to a specific address, a transaction description of one outputs is appropriate, where that output is a regular P2PKH output sending value to that address.
