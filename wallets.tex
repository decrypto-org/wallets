...
%cite meiklejohn
%cite On the Privacy Provisions of Bloom Filters in Lightweight Bitcoin Clients
...
%TODO: verification against the commitment tree in lieu of wtxid
...
The server is a full-node that maintains the whole chain and its tip. When a client requests their transactions and only then does it scan the blocks starting from the last processed block for the requested viewing key up until the tip.
