...
A valid transaction according to a state can be applied to it to generate a new state. We perform this state transformation with a function $\ethapply(\ethstate, tx)$. The definition of $\ethapply$ is given in \cref{alg.ethapply}.
